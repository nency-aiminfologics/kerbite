                ...
                2xl:py-[94.37px] xl:py-[84px] lg:py-[80px] md:py-[70px] py-[50px]">
                    <div className="2xl:w-[1350px] xl:w-[1150px] lg:w-[904px] md:w-[668px] w-[90%]  mx-auto ">
                        ...
                        <div className="lg:block md:block 2xl:hidden xl:hidden">
                            ...
                            <div className="lg:flex md:flex hidden lg:flex-row md:flex-row flex-col justify-between lg:mt-[48px] md:mt-[52px] mt-[35px]">
                     ...
                     <div className="w-[320px] h-[327px] mt-[25px] mx-auto lg:hidden md:hidden flex flex-col justify-between relative">
                                <div></div>
                                <div className="bg-[#FFF3CEB2] w-[100%] h-[21vh] rounded-[15.21px] relative">
                                    <div className="absolute z-10 bottom-0 left-1/9">
                                        <Image
