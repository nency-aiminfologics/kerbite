            ...
            <div className="2x:py-[100px] xl:py-[90px] lg:py-[80px] md:py-[75px] py-[40px] bg-[#F7F7F7] w-full ">
                <div className="2xl:w-[1440px] xl:w-[1280px] lg:w-[1024px] md:w-[768px] w-[335px] mx-auto ">
                    <div className="2xl:w-[1350px] xl:w-[1150px] lg:w-[904px] md:w-[668px] w-[325px]   mx-auto ">
                        ...
                        2xl:gap-[30px] xl:gap-[27px] lg:gap-[18px] md:gap-[16px] gap-[20px]">
                            <div className="grid grid-cols-1 2xl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2
                             ...
                             bg-[#FFFFFF] border-[1px] border-[#E2E2E2] relative overflow-visible">
                                    ...
                                    <div className="overflow-visible flex 2xl:gap-[15px] xl:gap-[15px] lg:gap-[12.88px] md:gap-[11px] gap-[10px]">
                                        ...
                                        md:w-[50px] md:h-[126px] w-[60px] h-[128px]
                                     bg-[#F3F3F3]  2xl:mt-[19px] xl:mt-[17px] lg:mt-[19.49px] md:mt-[17px] mt-[16px]
                                      rounded-tr-[10px] rounded-br-[10px]"></div>
                                        ...
                                        <div className="2xl:w-[233px] 2xl:h-[174px] xl:w-[207px] xl:h-[155px] lg:w-[249px] lg:h-[186px]
                                         md:w-[215px] md:h-[160px] w-[193px] h-[162px]
                                    ...
                                    2xl:mt-[27px] xl:mt-[24px] lg:mt-[30px] md:mt-[31px] mt-[30px] mx-auto ">

                                        <h1 className=" 2xl:text-[24px] xl:text-[18px] lg:text-[20px] md:text-[20px] text-[17px]
                                         text-[#1B1A1F] font-medium geologica leading-[100%] ">
                                            Barcode Scan</h1>

                                        <p className=" 2xl:w-[323px] xl:w-[287px] lg:w-[256px] md:w-[261px] w-[258px]
                                ...
                                2xl:rounded-[30px] xl:rounded-[26px] lg:rounded-[30px] md:rounded-[24px] rounded-[30px]
                                  bg-[#FFFFFF] border-[1px] border-[#E2E2E2]">
                                    ...
                                    2xl:mx-[65px] xl:mx-[59.56px] lg:mx-[54.44px] md:mx-[47px] mx-[53px]
                                    2xl:mt-[4px] xl:mt-[3.56px] lg:mt-[9.27px] md:mt-[8px] mt-[4px]">
                                        ...
                                        <Image src="/Images/what card2-bg.png" alt="circle" width={218} height={218}
                                            ...
                                            lg:w-[268.71px] lg:h-[268.71px] md:w-[232px] md:h-[232px]" />
                                    </div>

                                    <div className="absolute z-10 
                                    2xl:mt-[75px] xl:mt-[70.22px] lg:mt-[87px] md:mt-[72px] mt-[74px]
                                    2xl:mx-[43px] xl:mx-[38.22px] lg:mx-[19px] md:mx-[17px] mx-[31px]">
                                    ...
                                    <div className=" 2xl:w-[323px] xl:w-[287px] lg:w-[302px] md:w-[270px] w-[277px]
                                    2xl:mt-[234px] xl:mt-[208px] lg:mt-[244px] md:mt-[215px] mt-[210px]
                                     mx-auto">
                                        <h1 className=" 2xl:text-[24px] xl:text-[18px] lg:text-[20px] md:text-[20px] text-[17px]
                                         leading-[100%] font-medium text-[#1B1A1F] geologica">
                                            AI Food Scan</h1>

                                        <p className=" 2xl:text-[18px] xl:text-[16px] lg:text-[16px] md:text-[16px] text-[16px]
                            ...
                            bg-[#FFFFFF] border-[1px] border-[#E2E2E2]">
                                    ...
                                    flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row flex-col justify-between ">
                                        {/* leff part */}
                                        <div className=" flex flex-row 2xl:flex-col xl:flex-col lg:flex-col md:flex-col gap-[10px] 2xl:gap-0 xl:gap-0 md:gap-0 lg:gap-0">
                                            <div className="2xl:w-[68px] 2xl:h-[68px] xl:w-[60px] xl:h-[60px]
                                            lg:w-[61.39px] lg:h-[61.39px] md:w-[53px] md:h-[53px] w-[40px] h-[40px]
                                        ...
                                        2xl:mt-[9px] xl:mt-[8px] lg:mt-[9.93px] md:mt-[8.57px] mt-[6.67px] mx-auto " />
                                            ...
                                            <h1 className="2xl:text-[24px] xl:text-[18px] lg:text-[20px] md:text-[17px] text-[15px]
                                             2xl:w-[137px] xl:w-[122px] lg:w-[180px] md:w-[153px]
                                             2xl:mt-[26px] xl:mt-[23px] lg:mt-[28.96px] md:mt-[25px] mt-[15px]
                                         text-[#1B1A1F] geologica font-medium leading-[100%]">
                                                Insights & Reports</h1>

                                            <p className="2xl:w-[358px] xl:w-[319px] lg:w-[359.05px] md:w-[310px]
                                            2xl:text-[18px] xl:text-[16px] lg:text-[16px] md:text-[16px]
                                            2xl:mt-[100px] xl:mt-[90px] lg:mt-[36.96px] md:mt-[32px]
                                            leading-[125%] text-[#7D7C81]  geologica font-light hidden 2xl:block xl:block lg:block md:block ">
                                        ...
                                        {/* right part */}
                                        <div className="flex 2xl:flex-row xl:flex-row md:flex-row lg:flex-row  flex-col
                                         2xl:gap-[11.79px] xl:gap-[10px] lg:gap-[8px] md:gap-[7px] gap-[10px]">

                                            {/* right card  */}
                                            <div className="2xl:w-[162px]  xl:w-[144px] 
                                            lg:w-[147px]  md:w-[127px]  2xl:py-[35px] xl:py-[31px] lg:py-[20px] md:py-[16px] py-[13px] 
                                            ...
                                            2xl:w-full xl:w-full lg:w-full md:w-full justify-between  mx-auto ">
                                                ...
                                                2xl:mx-[16px] xl:mx-[14px] lg:mx-[15px] md:mx-[12px] mx-[12px] 
                                                 flex justify-between">
                                                    <h1 className="2xl:w-[88px] xl:w-[79px] lg:w-[69px] md:w-[59.15px]
